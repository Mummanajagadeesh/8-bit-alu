module alu8 (CarryOut,
 ...
 sky130_fd_sc_hd__xnor2_4 _177_ (.A(_109_),
    .B(net10),
    .Y(_110_));
 sky130_fd_sc_hd__nand2_1 _178_ (.A(net9),
    .B(net1),
    .Y(_111_));
 ...
 sky130_fd_sc_hd__o21ai_1 _277_ (.A1(_019_),
    ...
    .B1(_030_),
    .Y(_031_));
 sky130_fd_sc_hd__or3b_4 _278_ (.A(_016_),
    .B(_025_),
    .C_N(_031_),
    .X(_032_));
 ...
 sky130_fd_sc_hd__or4b_1 _355_ (.A(net19),
    ...
    .D_N(net20),
    .X(_103_));
 sky130_fd_sc_hd__or4b_4 _356_ (.A(net23),
    .B(net24),
    .C(net22),
    .D_N(_103_),
    .X(_104_));
 ...
 sky130_fd_sc_hd__buf_6 output30 (.A(net30),
    .X(Zero));
 sky130_fd_sc_hd__clkbuf_1 max_cap31 (.A(_115_),
    .X(net31));
