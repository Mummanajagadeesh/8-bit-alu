...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {Sel[3]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {CarryOut}]
