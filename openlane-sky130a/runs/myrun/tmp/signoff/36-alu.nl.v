module alu (CarryOut,
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_26_222 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_31_285 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_37_236 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_38_203 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_38_263 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_64_357 ();
 ...
 sky130_fd_sc_hd__clkbuf_4 _180_ (.A(net17),
    .X(_113_));
 sky130_fd_sc_hd__buf_4 _181_ (.A(net18),
    .X(_114_));
 ...
 sky130_fd_sc_hd__or2b_1 _184_ (.A(net1),
    .B_N(net9),
    .X(_117_));
 sky130_fd_sc_hd__nor2_1 _185_ (.A(net33),
    .B(_117_),
    .Y(_118_));
 ...
 sky130_fd_sc_hd__or2_1 _188_ (.A(_114_),
    .B(_120_),
    .X(_121_));
 sky130_fd_sc_hd__a21o_1 _189_ (.A1(net33),
    .A2(_117_),
    .B1(_121_),
    .X(_122_));
 ...
 sky130_fd_sc_hd__or3b_4 _193_ (.A(_114_),
    ...
    .C_N(_113_),
    .X(_126_));
 sky130_fd_sc_hd__or3_4 _194_ (.A(_113_),
    .B(net18),
    .C(_125_),
    .X(_127_));
 ...
 sky130_fd_sc_hd__and2b_1 _210_ (.A_N(net10),
    .B(_109_),
    .X(_142_));
 sky130_fd_sc_hd__a21o_1 _211_ (.A1(net33),
    .A2(_117_),
    .B1(_142_),
    .X(_143_));
 ...
 sky130_fd_sc_hd__nand2_1 _216_ (.A(net3),
    .B(net11),
    .Y(_148_));
 sky130_fd_sc_hd__or3_4 _217_ (.A(net1),
    .B(_109_),
    .C(net3),
    .X(_149_));
 ...
 sky130_fd_sc_hd__o21ai_2 _233_ (.A1(_144_),
    ...
    .B1(_164_),
    .Y(net24));
 sky130_fd_sc_hd__or2_4 _234_ (.A(net4),
    .B(_149_),
    .X(_165_));
 ...
 sky130_fd_sc_hd__or3b_1 _278_ (.A(_016_),
    ...
    .C_N(_031_),
    .X(_032_));
 sky130_fd_sc_hd__clkbuf_2 _279_ (.A(_032_),
    .X(net26));
 ...
 sky130_fd_sc_hd__or4b_1 _356_ (.A(net23),
    ...
    .D_N(_103_),
    .X(_104_));
 sky130_fd_sc_hd__or4_4 _357_ (.A(net25),
    .B(net26),
    .C(net27),
    .D(_104_),
    .X(_105_));
 ...
 sky130_fd_sc_hd__or4bb_1 _360_ (.A(_018_),
    ...
    .D_N(_035_),
    .X(_108_));
 sky130_fd_sc_hd__o31ai_2 _361_ (.A1(net28),
    .A2(net29),
    .A3(_105_),
    .B1(_108_),
    .Y(net30));
 ...
 sky130_fd_sc_hd__buf_4 output30 (.A(net30),
    .X(Zero));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer1 (.A(_110_),
    .X(net33));
endmodule
